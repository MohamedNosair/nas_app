...
final String operatingSystem = UniversalPlatform.operatingSystem;
...
/// The result is limited to 10 items (https://tppr.me/QYsm9) if `options` or
/// `modifiers` is used in `include` field. Refer to this link
/// https://developer.bigcommerce.com/api-reference/4101d472a814d-get-all-products.
/// So we need to override apiPageSize to 10 instead
...
class SettingConstants {
  static const aboutUsUrl = 'https://anas.co.il/%d8%b9%d9%86-%d8%a7%d9%84%d9%86%d8%a7%d8%b3/';
}
