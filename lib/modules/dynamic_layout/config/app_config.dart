...
class AppConfig {
  ...
  bool? get showQRCode {
    final searchTab = (jsonData['TabBar'] as List)
        .firstWhereOrNull((e) => e['layout'] == 'search');

    if (searchTab != null) {
      return bool.tryParse(searchTab['showQRCode'].toString());
    }
    return true;
  }
...
class TabBarMenuConfig {
  ...
  /// Used for icon is image type only
