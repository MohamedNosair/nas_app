            ...
            children: [
              if (logo != null) ...[
                Container(
                  ...
                  child: Center(
                    child: FluxImage(
                      width: drawer.logoConfig.width?.toDouble(),
          ...
          return ListTile(
            ...
            onTap: () {
              pushNavigator(
                screen: SafeArea(
                  child: WebView(
                    'https://anas.co.il/radio',
                    showAppBar: false,
                    enableBackward: false,
                    enableClose: false, enableForward: false,
          ...
          return ListTile(
            ...
            onTap: () {
              pushNavigator(
                screen: SafeArea(
                  child: WebView(
                    'https://anas.co.il/%d8%aa%d9%88%d8%a7%d8%b5%d9%84-%d9%85%d8%b9%d9%86%d8%a7/',
                    showAppBar: false,
                    enableBackward: false,
                    enableClose: false, enableForward: false,
                    //title: S.of(context).webView,
          ...
          return ListTile(
            ...
            onTap: () {
              pushNavigator(
                screen: SafeArea(
                  child: WebView(
                    'https://anas.co.il/%d8%a3%d8%b9%d9%84%d9%86-%d9%85%d8%b9%d9%86%d8%a7/',
                    showAppBar: false,
                    enableBackward: false,
                    enableClose: false, enableForward: false,
                    //title: S.of(context).webView,
