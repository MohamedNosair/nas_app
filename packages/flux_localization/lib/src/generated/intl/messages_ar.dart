...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(x) => "نشط منذ ${x}";

  static String m1(attribute) => "أي ${attribute}";

  static String m2(point) => "نقاطك المتاحة: ${point}";

  static String m3(state) => "محول البلوتوث ${state}";

  static String m4(author) => "الكاتب: ${author}";

  static String m5(fieldName) => "لا يمكن أن يكون ${fieldName} فارغاً";

  static String m6(fieldName) => "يجب ألا يقل طول ${fieldName} عن 3 أحرف";

  static String m7(currency) => "تم تغيير العملة إلى ${currency}";

  static String m8(number) => "متبقي ${number} حرف";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} نقطة";

  static String m10(count) => "${count} عنصر";

  static String m11(count) => "${count} عنصر";

  static String m12(count) => "${count} منتج";

  static String m13(count) => "${count} اخبار";

  static String m14(country) => "البلد ${country} غير مدعوم";

  static String m15(currency) => "العملة ${currency} غير مدعومة";

  static String m16(day) => "قبل ${day} يوم";

  static String m17(total) => "~${total} كم";

  static String m18(timeLeft) => "ينتهي في ${timeLeft}";

  static String m19(captcha) => "أدخل ${captcha} للتأكيد:";

  static String m20(message) => "خطأ: ${message}";

  static String m21(message) => "خطأ: ${message}";

  static String m22(time) => "تنتهي الصلاحية في ${time}";

  static String m23(total) => "أكثر من ${total} كم";

  static String m24(hour) => "قبل ${hour} ساعة";

  static String m25(currentBalance) => "لديك فقط ${currentBalance} في محفظتك";

  static String m26(message) =>
      "هناك مشكلة في التطبيق أثناء طلب البيانات، يرجى الاتصال بالمسؤول لإصلاح المشكلة: ${message}";

  static String m27(currency, amount) =>
      "الحد الأقصى لمبلغ هذه الطريقة هو ${currency} ${amount}";

  static String m28(size) => "الحد الأقصى لحجم الملف: ${size} ميجابايت";

  static String m29(name, formattedPrice) => "${name}: ${formattedPrice}";

  static String m30(currency, amount) =>
      "الحد الأدنى لمبلغ هذه الطريقة هو ${currency} ${amount}";

  static String m31(minute) => "قبل ${minute} دقيقة";

  static String m32(month) => "منذ ${month} شهر";

  static String m33(store) => "المزيد من ${store}";

  static String m34(number) => "يجب الشراء بمجموعات من ${number}";

  static String m35(itemCount) => "${itemCount} عنصر";

  static String m36(price) => "إجمالي الخيارات: ${price}";

  static String m37(amount) => "ادفع ${amount}";

  static String m38(name) => "تمت إضافة ${name} إلى السلة بنجاح";

  static String m39(total) => "الكمية: ${total}";

  static String m40(name) => "استلمت مبلغاً من ${name}";

  static String m41(count) => "هل تريد إزالة ${count} عنصر من قائمة رغباتك؟";

  static String m42(percent) => "خصم ${percent}٪";

  static String m43(keyword) => "نتائج البحث عن: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} عنصر)";

  static String m45(keyword, count) => "${keyword} (${count} عنصر)";

  static String m46(second) => "قبل ${second} ثانية";

  static String m47(totalCartQuantity) =>
      "سلة التسوق، ${totalCartQuantity} عنصر";

  static String m48(numberOfUnitsSold) => "تم البيع: ${numberOfUnitsSold}";

  static String m49(fieldName) => "حقل ${fieldName} مطلوب";

  static String m50(total) => "${total} منتج";

  static String m51(name) => "تحويل مبلغ إلى ${name}";

  static String m52(maxPointDiscount, maxPriceDiscount) =>
      "استخدم ${maxPointDiscount} نقطة للحصول على خصم ${maxPriceDiscount} على هذا الطلب!";

  static String m53(date) => "صالح حتى ${date}";

  static String m54(number) => "الإصدار ${number}";

  static String m55(balance) => "رصيد المحفظة: ${balance}";

  static String m56(message) => "تحذير: ${message}";

  static String m57(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m58(length) => "تم العثور على ${length} منتج";

  static String m59(week) => "الأسبوع ${week}";

  static String m60(name) => "مرحباً ${name}";

  static String m61(year) => "منذ ${year} سنة";

  static String m62(count) => "أنت تختار ${count} عنصر";

  static String m63(total) => "تم تعيينك للطلب رقم ${total}";

  static String m64(point) => "لديك ${point} نقطة";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("قيد الموافقة"),
        "accountDeleteDescription": MessageLookupByLibrary.simpleMessage(
            "حذف حسابك يزيل المعلومات الشخصية من قاعدة بياناتنا. يصبح بريدك الإلكتروني محجوزاً بشكل دائم ولا يمكن إعادة استخدام نفس البريد الإلكتروني لتسجيل حساب جديد."),
        ...
        "accountSetup": MessageLookupByLibrary.simpleMessage("إعداد الحساب"),
        "active": MessageLookupByLibrary.simpleMessage("نشط"),
        "activeFor": m0,
        "activeLongAgo":
            MessageLookupByLibrary.simpleMessage("نشط منذ فترة طويلة"),
        "activeNow": MessageLookupByLibrary.simpleMessage("نشط الآن"),
        "addAName": MessageLookupByLibrary.simpleMessage("أضف اسماً"),
        "addANewPost": MessageLookupByLibrary.simpleMessage("إضافة منشور جديد"),
        "addASlug": MessageLookupByLibrary.simpleMessage("أضف رابطاً مختصراً"),
        "addAnAttr": MessageLookupByLibrary.simpleMessage("أضف خاصية"),
        "addListing": MessageLookupByLibrary.simpleMessage("إضافة قائمة"),
        "addMessage": MessageLookupByLibrary.simpleMessage("إضافة رسالة"),
        "addNew": MessageLookupByLibrary.simpleMessage("إضافة جديد"),
        "addNewAddress":
            MessageLookupByLibrary.simpleMessage("إضافة عنوان جديد"),
        "addNewBlog": MessageLookupByLibrary.simpleMessage("إضافة مدونة جديدة"),
        ...
        "addToOrder": MessageLookupByLibrary.simpleMessage("إضافة إلى الطلب"),
        "addToQuoteRequest":
            MessageLookupByLibrary.simpleMessage("إضافة إلى طلب عرض السعر"),
        "addToWishlist":
            MessageLookupByLibrary.simpleMessage("إضافة إلى قائمة الرغبات"),
        ...
        "agreeWithPrivacy":
            MessageLookupByLibrary.simpleMessage("الموافقة على سياسة الخصوصية"),
        ...
        "allProducts": MessageLookupByLibrary.simpleMessage("جميع الاخبار"),
        ...
        "almostSoldOut": MessageLookupByLibrary.simpleMessage("على وشك النفاد"),
        "amazing": MessageLookupByLibrary.simpleMessage("رائع"),
        ...
        "audioDetected": MessageLookupByLibrary.simpleMessage(
            "تم اكتشاف محتوى صوتي. هل تريد إضافة مشغل الصوت؟"),
        ...
        "backToWallet":
            MessageLookupByLibrary.simpleMessage("العودة إلى المحفظة"),
        "bagsCollections":
        ...
        "bannerYoutubeURL":
            MessageLookupByLibrary.simpleMessage("رابط يوتيوب للبانر"),
        "basicInformation":
            MessageLookupByLibrary.simpleMessage("معلومات أساسية"),
        "becomeAVendor":
            MessageLookupByLibrary.simpleMessage("كن بائعاً في سوق البلد"),
        ...
        "bleHasNotBeenEnabled":
            MessageLookupByLibrary.simpleMessage("لم يتم تفعيل البلوتوث"),
        "bleState": m3,
        ...
        "booked": MessageLookupByLibrary.simpleMessage("تم الحجز بالفعل"),
        "booking": MessageLookupByLibrary.simpleMessage("الحجز"),
        "bookingCancelled":
            MessageLookupByLibrary.simpleMessage("تم إلغاء الحجز"),
        "bookingConfirm": MessageLookupByLibrary.simpleMessage("تم التأكيد"),
        "bookingError": MessageLookupByLibrary.simpleMessage(
            "هناك خطأ ما. الرجاء المحاولة مرة أخرى لاحقاً."),
        ...
        "branchChangeWarning": MessageLookupByLibrary.simpleMessage(
            "عذراً، سيتم تفريغ سلة المشتريات بسبب تغيير المنطقة. يسعدنا مساعدتك إذا كنت بحاجة إلى ذلك"),
        ...
        "byAppointmentOnly":
            MessageLookupByLibrary.simpleMessage("بالموعد فقط"),
        "byAuthor": m4,
        "byBrand": MessageLookupByLibrary.simpleMessage("حسب العلامة التجارية"),
        "byCategory": MessageLookupByLibrary.simpleMessage("حسب الفئة"),
        "byPrice": MessageLookupByLibrary.simpleMessage("حسب السعر"),
        "bySignup":
            MessageLookupByLibrary.simpleMessage("بالتسجيل، فإنك توافق على"),
        "byTag": MessageLookupByLibrary.simpleMessage("بواسطة العلامة"),
        "call": MessageLookupByLibrary.simpleMessage("اتصال"),
        "callTo": MessageLookupByLibrary.simpleMessage("اتصل بـ"),
        "callToVendor": MessageLookupByLibrary.simpleMessage("اتصل بالبائع"),
        "canNotCreateOrder":
            MessageLookupByLibrary.simpleMessage("لا يمكن إنشاء الطلب"),
        "canNotCreateUser":
        ...
        "canNotGetToken": MessageLookupByLibrary.simpleMessage(
            "لا يمكن الحصول على رمز التفعيل"),
        "canNotLaunch": MessageLookupByLibrary.simpleMessage(
            "لا يمكن تشغيل هذا التطبيق. تأكد من صحة إعداداتك"),
        "canNotLoadThisLink":
        ...
        "cantFindThisOrderId": MessageLookupByLibrary.simpleMessage(
            "لا يمكن العثور على رقم الطلب هذا"),
        ...
        "cartDiscount": MessageLookupByLibrary.simpleMessage("خصم السلة"),
        ...
        "chooseStaff": MessageLookupByLibrary.simpleMessage("اختر الموظف"),
        ...
        "cityIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل المدينة مطلوب"),
        "clear": MessageLookupByLibrary.simpleMessage("مسح"),
        "clearCart": MessageLookupByLibrary.simpleMessage("إفراغ السلة"),
        "clearCartAndAddNew":
            MessageLookupByLibrary.simpleMessage("مسح السلة وإضافة منتج جديد"),
        "clearConversation":
        ...
        "codExtraFee": MessageLookupByLibrary.simpleMessage(
            "رسوم إضافية للدفع عند الاستلام"),
        "color": MessageLookupByLibrary.simpleMessage("اللون"),
        "comment": MessageLookupByLibrary.simpleMessage("تعليق"),
        "commentFirst":
            MessageLookupByLibrary.simpleMessage("يرجى كتابة تعليقك"),
        "commentSuccessfully": MessageLookupByLibrary.simpleMessage(
            "تم التعليق بنجاح، يرجى الانتظار حتى تتم الموافقة على تعليقك"),
        ...
        "confirmClearCartWhenTopUp":
            MessageLookupByLibrary.simpleMessage("سيتم مسح السلة عند الشحن."),
        "confirmClearTheCart": MessageLookupByLibrary.simpleMessage(
            "هل أنت متأكد من رغبتك في مسح سلة التسوق؟"),
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("متابعة لاختيار العنصر"),
        "continueToShipping":
            MessageLookupByLibrary.simpleMessage("متابعة إلى الشحن"),
        ...
        "countryCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("رمز البلد مطلوب"),
        "countryIsNotSupported": m14,
        "countryIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل الدولة مطلوب"),
        ...
        "createNewPostSuccessfully": MessageLookupByLibrary.simpleMessage(
            "تم إنشاء منشورك بنجاح كمسودة. يرجى إلقاء نظرة على لوحة الإدارة."),
        "createPost": MessageLookupByLibrary.simpleMessage("إنشاء منشور"),
        "createProduct": MessageLookupByLibrary.simpleMessage("إضافة منتج"),
        "createReviewSuccess":
            MessageLookupByLibrary.simpleMessage("شكراً لمراجعتك"),
        "createReviewSuccessMsg": MessageLookupByLibrary.simpleMessage(
            "نقدر مشاركتك ومساهمتك في تحسين خدماتنا"),
        "createVariants":
        ...
        "customerNote": MessageLookupByLibrary.simpleMessage("ملاحظة العميل"),
        "cvv": MessageLookupByLibrary.simpleMessage("CVV"),
        "czech": MessageLookupByLibrary.simpleMessage("التشيكية"),
        "danish": MessageLookupByLibrary.simpleMessage("الدنماركية"),
        ...
        "dateDESC": MessageLookupByLibrary.simpleMessage("التاريخ تنازلياً"),
        "dateEnd": MessageLookupByLibrary.simpleMessage("تاريخ الانتهاء"),
        ...
        "dateWiseClose":
            MessageLookupByLibrary.simpleMessage("إغلاق حسب التاريخ"),
        "daysAgo": m16,
        ...
        "deliveredTo": MessageLookupByLibrary.simpleMessage("تم التسليم إلى"),
        "delivering": MessageLookupByLibrary.simpleMessage("جارٍ التوصيل"),
        ...
        "deliveryManagement": MessageLookupByLibrary.simpleMessage("التوصيل"),
        "deliveryNotificationError": MessageLookupByLibrary.simpleMessage(
            "لا توجد بيانات.\nتم حذف هذا الطلب."),
        "description": MessageLookupByLibrary.simpleMessage("الوصف"),
        "descriptionEnterVoucher": MessageLookupByLibrary.simpleMessage(
            "يرجى إدخال أو اختيار قسيمة لطلبك"),
        "didntReceiveCode":
        ...
        "doYouWantToLeaveWithoutSubmit": MessageLookupByLibrary.simpleMessage(
            "هل تريد المغادرة دون إرسال رأيك؟"),
        "doYouWantToLogout":
        ...
        "doesNotSupportApplePay": MessageLookupByLibrary.simpleMessage(
            "خدمة Apple Pay غير مدعومة. يرجى التحقق من محفظتك وبطاقتك"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("جارٍ تنزيل الصور..."),
        "draft": MessageLookupByLibrary.simpleMessage("مسودة"),
        "driverAssigned":
            MessageLookupByLibrary.simpleMessage("تم تعيين السائق"),
        ...
        "editProductInfo":
            MessageLookupByLibrary.simpleMessage("تعديل معلومات المنتج"),
        "editWithoutColon": MessageLookupByLibrary.simpleMessage("تعديل"),
        ...
        "emailDeleteDescription": MessageLookupByLibrary.simpleMessage(
            "حذف حسابك سيلغي اشتراكك من جميع القوائم البريدية."),
        "emailDoesNotExist": MessageLookupByLibrary.simpleMessage(
            "البريد الإلكتروني الذي أدخلته غير موجود. الرجاء المحاولة مرة أخرى."),
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل البريد الإلكتروني مطلوب"),
        "emailSubscription":
            MessageLookupByLibrary.simpleMessage("الاشتراك البريدي"),
        "emptyBookingHistoryMsg": MessageLookupByLibrary.simpleMessage(
            "يبدو أنك لم تقم بأي حجوزات بعد. ابدأ بالاستكشاف واحجز أول موعد لك!"),
        "emptyCart": MessageLookupByLibrary.simpleMessage("السلة فارغة"),
        "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
            "يبدو أنك لم تضف أي اخبار إلى السلة بعد. ابدأ التسوق الآن."),
        "emptyCartSubtitle02": MessageLookupByLibrary.simpleMessage(
            "عذراً! سلة التسوق خاصتك فارغة. هل أنت مستعد للتسوق؟"),
        "emptyComment": MessageLookupByLibrary.simpleMessage(
            "لا يمكن أن يكون التعليق فارغاً"),
        "emptySearch": MessageLookupByLibrary.simpleMessage(
            "لم تبحث عن أي عناصر حتى الآن. لنبدأ الآن - سنساعدك."),
        ...
        "emptyWishlist":
            MessageLookupByLibrary.simpleMessage("قائمة الرغبات فارغة"),
        "emptyWishlistSubtitle": MessageLookupByLibrary.simpleMessage(
            "اضغط على أيقونة القلب بجوار المنتج لإضافته إلى قائمة رغباتك. سنحفظها لك هنا!"),
        "emptyWishlistSubtitle02": MessageLookupByLibrary.simpleMessage(
            "قائمة رغباتك فارغة حالياً. ابدأ بإضافة اخبارك المفضلة!"),
        "enableForCheckout":
        ...
        "errorAmountTransfer": MessageLookupByLibrary.simpleMessage(
            "المبلغ المدخل أكبر من رصيد المحفظة الحالي. حاول مرة أخرى!"),
        "errorEmailFormat": MessageLookupByLibrary.simpleMessage(
            "الرجاء إدخال بريد إلكتروني صحيح."),
        "errorMsg": m21,
        "errorOnGettingPost":
            MessageLookupByLibrary.simpleMessage("خطأ في جلب المنشور!"),
        ...
        "expectedDeliveryDate":
            MessageLookupByLibrary.simpleMessage("تاريخ التوصيل المتوقع"),
        ...
        "failToAssign":
            MessageLookupByLibrary.simpleMessage("فشل في تعيين المستخدم"),
        "failedToGenerateLink":
            MessageLookupByLibrary.simpleMessage("فشل في إنشاء الرابط"),
        "failedToLoadAppConfig": MessageLookupByLibrary.simpleMessage(
            "فشل تحميل إعدادات التطبيق. يرجى إعادة تشغيل التطبيق"),
        "failedToLoadImage":
        ...
        "firstNameIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل الاسم الأول مطلوب"),
        ...
        "getNotified":
            MessageLookupByLibrary.simpleMessage("احصل على التنبيهات!"),
        "getPasswordLink":
        ...
        "goBackToReview":
            MessageLookupByLibrary.simpleMessage("العودة إلى المراجعة"),
        "goBackToShipping":
        ...
        "hasBeenDeleted": MessageLookupByLibrary.simpleMessage("تم الحذف"),
        "hebrew": MessageLookupByLibrary.simpleMessage("العبرية"),
        "hideAbout": MessageLookupByLibrary.simpleMessage("إخفاء معلومات عن"),
        ...
        "iAgree": MessageLookupByLibrary.simpleMessage("أوافق على"),
        ...
        "imageNetwork": MessageLookupByLibrary.simpleMessage("شبكة الصور"),
        ...
        "installDigitsPlugin": MessageLookupByLibrary.simpleMessage(
            "يرجى تثبيت إضافة DIGITS: تسجيل الدخول وإنشاء حساب برقم الهاتف لووردبريس"),
        ...
        "isEverythingSet":
            MessageLookupByLibrary.simpleMessage("هل كل شيء جاهز؟"),
        ...
        "itemTotal": MessageLookupByLibrary.simpleMessage("مجموع العناصر:"),
        ...
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("أريد إنشاء حساب"),
        ...
        "lastNameIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل اسم العائلة مطلوب"),
        "lastTransactions":
            MessageLookupByLibrary.simpleMessage("آخر المعاملات"),
        "latestProducts": MessageLookupByLibrary.simpleMessage("أحدث الاخبار"),
        ...
        "listBannerType":
            MessageLookupByLibrary.simpleMessage("نوع قائمة البانر"),
        "listBannerVideo":
            MessageLookupByLibrary.simpleMessage("قائمة فيديو البانر"),
        "listMessages": MessageLookupByLibrary.simpleMessage("قائمة الإشعارات"),
        "listening": MessageLookupByLibrary.simpleMessage("جارٍ الاستماع..."),
        ...
        "loadingLink":
            MessageLookupByLibrary.simpleMessage("جارٍ تحميل الرابط..."),
        "location": MessageLookupByLibrary.simpleMessage("الموقع"),
        "lockScreenAndSecurity":
            MessageLookupByLibrary.simpleMessage("قفل الشاشة والأمان"),
        ...
        "malay": MessageLookupByLibrary.simpleMessage("الملايو"),
        "manCollections":
            MessageLookupByLibrary.simpleMessage("مجموعات رجالية"),
        ...
        "markAsShipped": MessageLookupByLibrary.simpleMessage("تحديد كمشحون"),
        "markAsUnread":
            MessageLookupByLibrary.simpleMessage("تحديد كغير مقروء"),
        ...
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "أنت تحاول إضافة منتج من بائع جديد إلى سلتك. يرجى العلم أنه يمكنك الشراء من بائع واحد فقط في كل مرة"),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "أنت تحاول إضافة منتج من بائع جديد إلى سلتك. هل تريد المتابعة؟"),
        "mustBeBoughtInGroupsOf": m34,
        "mustSelectOneItem":
            MessageLookupByLibrary.simpleMessage("يجب اختيار عنصر واحد"),
        ...
        "myProducts": MessageLookupByLibrary.simpleMessage("اخباري"),
        "myProductsEmpty":
            MessageLookupByLibrary.simpleMessage("ليس لديك أي اخبار!"),
        "myRating": MessageLookupByLibrary.simpleMessage("تقييمي"),
        "myReviews": MessageLookupByLibrary.simpleMessage("تقييماتي"),
        "myWallet": MessageLookupByLibrary.simpleMessage("محفظتي"),
        "myWishList": MessageLookupByLibrary.simpleMessage("قائمة رغباتي"),
        "nItems": m35,
        ...
        "needHelp": MessageLookupByLibrary.simpleMessage("بحاجة إلى مساعدة؟"),
        ...
        "newVariation": MessageLookupByLibrary.simpleMessage("تنويع جديد"),
        "next": MessageLookupByLibrary.simpleMessage("التالي"),
        "niceName": MessageLookupByLibrary.simpleMessage("الاسم المستعار"),
        "no": MessageLookupByLibrary.simpleMessage("لا"),
        "noAddressHaveBeenSaved": MessageLookupByLibrary.simpleMessage(
            "لم يتم حفظ أي عناوين حتى الآن"),
        "noBackHistoryItem":
            MessageLookupByLibrary.simpleMessage("لا توجد عناصر سابقة"),
        "noBlog": MessageLookupByLibrary.simpleMessage(
            "عذراً، يبدو أن المدونة لم تعد موجودة"),
        "noCameraPermissionIsGranted": MessageLookupByLibrary.simpleMessage(
            "لم يتم منح إذن الوصول إلى الكاميرا. يرجى منحه في إعدادات جهازك."),
        "noComments": MessageLookupByLibrary.simpleMessage("لا توجد تعليقات"),
        "noConversation":
            MessageLookupByLibrary.simpleMessage("لا توجد محادثات حتى الآن"),
        "noConversationDescription": MessageLookupByLibrary.simpleMessage(
            "ستظهر المحادثات عندما يبدأ شخص ما بالتواصل معك"),
        ...
        "noForwardHistoryItem":
            MessageLookupByLibrary.simpleMessage("لا توجد عناصر لاحقة"),
        ...
        "noPermissionForCurrentRole": MessageLookupByLibrary.simpleMessage(
            "عذراً، لا يمكن الوصول إلى هذا المنتج بدورك الحالي"),
        "noPermissionToViewProduct": MessageLookupByLibrary.simpleMessage(
            "هذا المنتج متاح فقط للمستخدمين ذوي الأدوار المحددة. يرجى تسجيل الدخول بحساب مناسب للوصول إلى هذا المنتج أو الاتصال بنا للمزيد من المعلومات"),
        "noPermissionToViewProductMsg": MessageLookupByLibrary.simpleMessage(
            "يرجى تسجيل الدخول بحساب مناسب للوصول إلى هذا المنتج أو الاتصال بنا للمزيد من المعلومات"),
        "noPost": MessageLookupByLibrary.simpleMessage(
            "عذراً، يبدو أن هذه الصفحة لم تعد موجودة!"),
        "noPrinters": MessageLookupByLibrary.simpleMessage("لا توجد طابعات"),
        "noProduct": MessageLookupByLibrary.simpleMessage("لا توجد اخبار"),
        "noResultFound":
        ...
        "noSlotAvailable":
            MessageLookupByLibrary.simpleMessage("لا توجد فترات متاحة"),
        "noStoreNearby":
        ...
        "noTransactionsMsg": MessageLookupByLibrary.simpleMessage(
            "عذراً، لم يتم العثور على معاملات!"),
        "noVideoFound": MessageLookupByLibrary.simpleMessage(
            "عذراً، لم يتم العثور على فيديوهات"),
        "none": MessageLookupByLibrary.simpleMessage("لا شيء"),
        "notFindResult": MessageLookupByLibrary.simpleMessage(
            "عذراً، لم نتمكن من العثور على أي نتائج"),
        "notFound": MessageLookupByLibrary.simpleMessage("غير موجود"),
        "notRated": MessageLookupByLibrary.simpleMessage("لم يتم التقييم"),
        ...
        "onVacation": MessageLookupByLibrary.simpleMessage("في إجازة"),
        "oneEachRecipient":
            MessageLookupByLibrary.simpleMessage("واحد لكل مستلم"),
        ...
        "orderStatusCanceledReversal":
            MessageLookupByLibrary.simpleMessage("إلغاء العكس"),
        ...
        "orderStatusFailed": MessageLookupByLibrary.simpleMessage("فشل"),
        "orderStatusOnHold":
        ...
        "orderStatusRefunded": MessageLookupByLibrary.simpleMessage("مسترد"),
        "orderStatusReversed": MessageLookupByLibrary.simpleMessage("معكوس"),
        "orderStatusShipped": MessageLookupByLibrary.simpleMessage("تم الشحن"),
        "orderStatusVoided": MessageLookupByLibrary.simpleMessage("ملغي"),
        "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
            "يمكنك التحقق من حالة طلبك باستخدام ميزة تتبع الطلب. ستتلقى رسالة تأكيد بالبريد الإلكتروني تحتوي على تفاصيل طلبك ورابط لتتبع حالته."),
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "يمكنك تسجيل الدخول إلى حسابك باستخدام البريد الإلكتروني وكلمة المرور المحددة مسبقاً. في حسابك يمكنك تعديل بيانات ملفك الشخصي، والتحقق من سجل المعاملات، وتعديل اشتراكك في النشرة الإخبارية."),
        "orderSuccessTitle1":
            MessageLookupByLibrary.simpleMessage("لقد تم تقديم طلبك بنجاح"),
        "orderSuccessTitle2": MessageLookupByLibrary.simpleMessage("حسابك"),
        ...
        "otpVerification":
            MessageLookupByLibrary.simpleMessage("التحقق من رمز التفعيل"),
        "ourBankDetails": MessageLookupByLibrary.simpleMessage("تفاصيل البنك"),
        ...
        "pasteYourImageUrl":
            MessageLookupByLibrary.simpleMessage("الصق رابط صورتك"),
        "payByWallet": MessageLookupByLibrary.simpleMessage("الدفع بالمحفظة"),
        "payNow": MessageLookupByLibrary.simpleMessage("ادفع الآن"),
        "payWithAmount": m37,
        "payment": MessageLookupByLibrary.simpleMessage("الدفع"),
        "paymentDetailsChangedSuccessfully":
            MessageLookupByLibrary.simpleMessage("تم تغيير تفاصيل الدفع بنجاح"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("التقييمات المعلقة"),
        "persian": MessageLookupByLibrary.simpleMessage("الفارسية"),
        "phone": MessageLookupByLibrary.simpleMessage("الهاتف"),
        "phoneEmpty": MessageLookupByLibrary.simpleMessage("رقم الهاتف فارغ"),
        "phoneHintFormat":
            MessageLookupByLibrary.simpleMessage("الصيغة: +213-000-00-00-00"),
        "phoneIsRequired":
        ...
        "picking": MessageLookupByLibrary.simpleMessage("جارٍ التجهيز"),
        "placeMyOrder": MessageLookupByLibrary.simpleMessage("تأكيد الطلب"),
        "playAll": MessageLookupByLibrary.simpleMessage("تشغيل الكل"),
        "pleaseAddPrice":
            MessageLookupByLibrary.simpleMessage("الرجاء إضافة السعر"),
        "pleaseAgreeTerms":
            MessageLookupByLibrary.simpleMessage("يرجى الموافقة على شروطنا"),
        "pleaseAllowAccessCameraGallery": MessageLookupByLibrary.simpleMessage(
            "يرجى السماح بالوصول إلى الكاميرا ومعرض الصور"),
        ...
        "pleaseIncreaseOrDecreaseTheQuantity":
            MessageLookupByLibrary.simpleMessage(
                "يرجى زيادة أو تقليل الكمية للمتابعة"),
        "pleaseInput":
            MessageLookupByLibrary.simpleMessage("يرجى ملء جميع الحقول"),
        "pleaseInputFillAllFields":
            MessageLookupByLibrary.simpleMessage("يرجى ملء جميع الحقول"),
        "pleaseSelectADate":
            MessageLookupByLibrary.simpleMessage("الرجاء اختيار تاريخ الحجز"),
        "pleaseSelectALocation":
            MessageLookupByLibrary.simpleMessage("الرجاء اختيار موقع"),
        "pleaseSelectAllAttributes": MessageLookupByLibrary.simpleMessage(
            "يرجى اختيار خيار لكل سمة للمنتج"),
        "pleaseSelectAttr": MessageLookupByLibrary.simpleMessage(
            "الرجاء اختيار خيار واحد على الأقل لكل سمة نشطة"),
        "pleaseSelectImages":
            MessageLookupByLibrary.simpleMessage("الرجاء اختيار الصور"),
        "pleaseSelectRequiredOptions": MessageLookupByLibrary.simpleMessage(
            "يرجى اختيار الخيارات المطلوبة!"),
        "pleaseSignInBeforeUploading": MessageLookupByLibrary.simpleMessage(
            "الرجاء تسجيل الدخول إلى حسابك قبل رفع أي ملفات."),
        "point": MessageLookupByLibrary.simpleMessage("نقطة"),
        "pointMsgConfigNotFound": MessageLookupByLibrary.simpleMessage(
            "لم يتم العثور على إعدادات نقاط الخصم في الخادم"),
        "pointMsgEnter":
            MessageLookupByLibrary.simpleMessage("الرجاء إدخال نقاط الخصم"),
        "pointMsgMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage("الحد الأقصى لنقاط الخصم"),
        "pointMsgNotEnough": MessageLookupByLibrary.simpleMessage(
            "ليس لديك نقاط خصم كافية. مجموع نقاط الخصم المتاحة هو"),
        "pointMsgOverMaximumDiscountPoint":
            MessageLookupByLibrary.simpleMessage(
                "لقد وصلت إلى الحد الأقصى لنقاط الخصم"),
        "pointMsgOverTotalBill": MessageLookupByLibrary.simpleMessage(
            "إجمالي قيمة الخصم يتجاوز إجمالي الفاتورة"),
        "pointMsgRemove":
            MessageLookupByLibrary.simpleMessage("تم إزالة نقاط الخصم"),
        "pointMsgSuccess":
            MessageLookupByLibrary.simpleMessage("تم تطبيق نقاط الخصم بنجاح"),
        "pointRewardMessage": MessageLookupByLibrary.simpleMessage(
            "هناك خصم يمكنك تطبيقه من نقاطك على سلتك"),
        ...
        "postContent": MessageLookupByLibrary.simpleMessage("المحتوى"),
        "postFail": MessageLookupByLibrary.simpleMessage("فشل إنشاء منشورك"),
        "postImageFeature":
            MessageLookupByLibrary.simpleMessage("ميزة صورة المنشور"),
        "postManagement":
            MessageLookupByLibrary.simpleMessage("إدارة المنشورات"),
        "postProduct": MessageLookupByLibrary.simpleMessage("نشر المنتج"),
        "postSuccessfully":
            MessageLookupByLibrary.simpleMessage("تم إنشاء منشورك بنجاح"),
        "postTitle": MessageLookupByLibrary.simpleMessage("العنوان"),
        "prepaid": MessageLookupByLibrary.simpleMessage("مدفوع مسبقاً"),
        ...
        "printerSelection":
            MessageLookupByLibrary.simpleMessage("اختيار الطابعة"),
        "printing": MessageLookupByLibrary.simpleMessage("جارٍ الطباعة..."),
        "privacyAndTerm":
        ...
        "productCreateReview":
            MessageLookupByLibrary.simpleMessage("سيظهر منتجك بعد المراجعة."),
        "productExpired": MessageLookupByLibrary.simpleMessage(
            "عذراً، لا يمكن الوصول إلى هذا المنتج لانتهاء صلاحيته"),
        "productName": MessageLookupByLibrary.simpleMessage("اسم المنتج"),
        "productNameCanNotEmpty": MessageLookupByLibrary.simpleMessage(
            "لا يمكن أن يكون اسم المنتج فارغاً"),
        "productNeedAtLeastOneVariation": MessageLookupByLibrary.simpleMessage(
            "متغير نوع المنتج يحتاج إلى متغير واحد على الأقل"),
        "productNeedNameAndPrice": MessageLookupByLibrary.simpleMessage(
            "نوع المنتج البسيط يحتاج إلى الاسم والسعر العادي"),
        "productOutOfStock":
            MessageLookupByLibrary.simpleMessage("هذا المنتج نفد من المخزون"),
        "productOverview":
        ...
        "products": MessageLookupByLibrary.simpleMessage("الاخبار"),
        "promptPayID":
            MessageLookupByLibrary.simpleMessage("معرف الدفع السريع:"),
        "promptPayName":
            MessageLookupByLibrary.simpleMessage("اسم الدفع السريع:"),
        "promptPayType":
            MessageLookupByLibrary.simpleMessage("نوع الدفع السريع:"),
        "publish": MessageLookupByLibrary.simpleMessage("نشر"),
        "pullToLoadMore":
            MessageLookupByLibrary.simpleMessage("اسحب لتحميل المزيد"),
        "qRCodeMsgSuccess":
            MessageLookupByLibrary.simpleMessage("تم حفظ رمز QR بنجاح"),
        "qRCodeSaveFailure":
            MessageLookupByLibrary.simpleMessage("فشل في حفظ رمز QR"),
        "qty": MessageLookupByLibrary.simpleMessage("الكمية"),
        "qtyTotal": m39,
        "quantity": MessageLookupByLibrary.simpleMessage("الكمية"),
        "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
            "الكمية المطلوبة تتجاوز الكمية المتوفرة في المخزون"),
        ...
        "rateThisApp": MessageLookupByLibrary.simpleMessage("قيّم هذا التطبيق"),
        "rateThisAppDescription": MessageLookupByLibrary.simpleMessage(
            "إذا أعجبك هذا التطبيق، نرجو منك تقييمه. هذا يساعدنا حقاً ولن يستغرق منك أكثر من دقيقة."),
        "rating": MessageLookupByLibrary.simpleMessage("التقييم"),
        "ratingFirst": MessageLookupByLibrary.simpleMessage(
            "يرجى التقييم قبل إرسال تعليقك"),
        "reOrder": MessageLookupByLibrary.simpleMessage("إعادة الطلب"),
        "readReviews": MessageLookupByLibrary.simpleMessage("قراءة التقييمات"),
        "readyToPick": MessageLookupByLibrary.simpleMessage("جاهز للتجهيز"),
        "receivedMoney": MessageLookupByLibrary.simpleMessage("المبلغ المستلم"),
        ...
        "recentlyViewed": MessageLookupByLibrary.simpleMessage("شوهد مؤخراً"),
        ...
        "refundOrderFailed":
            MessageLookupByLibrary.simpleMessage("فشل طلب استرداد المبلغ"),
        "refundOrderSuccess": MessageLookupByLibrary.simpleMessage(
            "تم طلب استرداد المبلغ بنجاح!"),
        "refundRequest": MessageLookupByLibrary.simpleMessage("طلب استرداد"),
        "refundRequested":
            MessageLookupByLibrary.simpleMessage("تم طلب الاسترداد"),
        "refunds": MessageLookupByLibrary.simpleMessage("المبالغ المستردة"),
        "regenerateResponse":
            MessageLookupByLibrary.simpleMessage("إعادة توليد الرد"),
        ...
        "registerErrorSyncAccount": MessageLookupByLibrary.simpleMessage(
            "تعذرت مزامنة الحساب. يرجى تسجيل الدخول للمتابعة"),
        ...
        "relatedLayoutTitle":
            MessageLookupByLibrary.simpleMessage("أشياء قد تعجبك"),
        "releaseToLoadMore":
            MessageLookupByLibrary.simpleMessage("حرر للتحميل"),
        "remove": MessageLookupByLibrary.simpleMessage("إزالة"),
        "removeFromWishList":
            MessageLookupByLibrary.simpleMessage("إزالة من قائمة الرغبات"),
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("إزالة من قائمة الرغبات"),
        "removeWishlistContent": m41,
        "requestBooking": MessageLookupByLibrary.simpleMessage("طلب الحجز"),
        "requestTooMany": MessageLookupByLibrary.simpleMessage(
            "لقد طلبت عدداً كبيراً من الرموز في وقت قصير. الرجاء المحاولة لاحقاً."),
        ...
        "reviewApproval":
            MessageLookupByLibrary.simpleMessage("مراجعة الموافقة"),
        "reviewPendingApproval": MessageLookupByLibrary.simpleMessage(
            "تم إرسال تقييمك وينتظر الموافقة!"),
        "reviewSent": MessageLookupByLibrary.simpleMessage("تم إرسال تقييمك!"),
        ...
        "saveAddressSuccess":
            MessageLookupByLibrary.simpleMessage("تم حفظ عنوانك بنجاح"),
        "saveForLater": MessageLookupByLibrary.simpleMessage("حفظ لوقت لاحق"),
        "saveQRCode": MessageLookupByLibrary.simpleMessage("حفظ رمز QR"),
        "saveToWishList":
            MessageLookupByLibrary.simpleMessage("حفظ في قائمة الرغبات"),
        "scannerCannotScan":
            MessageLookupByLibrary.simpleMessage("لا يمكن مسح هذا العنصر"),
        ...
        "searchByCountryNameOrDialCode": MessageLookupByLibrary.simpleMessage(
            "البحث باسم البلد أو رمز الاتصال"),
        ...
        "searchEmptyDataMessage": MessageLookupByLibrary.simpleMessage(
            "عذراً! لا توجد نتائج تطابق معايير بحثك"),
        "searchForItems":
            MessageLookupByLibrary.simpleMessage("البحث عن اخبار"),
        "searchInput": MessageLookupByLibrary.simpleMessage(
            "يرجى كتابة ما تبحث عنه في حقل البحث"),
        "searchOrderId":
        ...
        "selectNone": MessageLookupByLibrary.simpleMessage("إلغاء الاختيار"),
        ...
        "selectStore": MessageLookupByLibrary.simpleMessage("اختر المتجر"),
        "selectTheColor": MessageLookupByLibrary.simpleMessage("اختر اللون"),
        "selectTheFile": MessageLookupByLibrary.simpleMessage("اختر الملف"),
        ...
        "sendBack": MessageLookupByLibrary.simpleMessage("إرجاع"),
        "sendSMSCode":
            MessageLookupByLibrary.simpleMessage("الحصول على رمز التحقق"),
        "sendSMStoVendor":
            MessageLookupByLibrary.simpleMessage("إرسال رسالة نصية للبائع"),
        ...
        "setup": MessageLookupByLibrary.simpleMessage("إعداد"),
        "share": MessageLookupByLibrary.simpleMessage("مشاركة"),
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("مشاركة بيانات المنتج"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("مشاركة رابط المنتج"),
        ...
        "shopSlug": MessageLookupByLibrary.simpleMessage("رابط المتجر المختصر"),
        "shoppingCartItems": m47,
        "shortDescription": MessageLookupByLibrary.simpleMessage("وصف قصير"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("عرض جميع طلباتي"),
        ...
        "smsCodeExpired": MessageLookupByLibrary.simpleMessage(
            "انتهت صلاحية رمز التحقق. يرجى إعادة إرسال رمز التحقق للمحاولة مرة أخرى"),
        "sold": m48,
        "soldBy": MessageLookupByLibrary.simpleMessage("يباع من قبل"),
        "somethingWrong": MessageLookupByLibrary.simpleMessage(
            "حدث خطأ ما. الرجاء المحاولة لاحقاً."),
        "sortBy": MessageLookupByLibrary.simpleMessage("ترتيب حسب"),
        "sortCode": MessageLookupByLibrary.simpleMessage("الرمز البنكي"),
        "spanish": MessageLookupByLibrary.simpleMessage("الإسبانية"),
        "speechNotAvailable":
            MessageLookupByLibrary.simpleMessage("خاصية النطق غير متوفرة"),
        "startExploring":
            MessageLookupByLibrary.simpleMessage("ابدأ الاستكشاف"),
        "startShopping": MessageLookupByLibrary.simpleMessage("تسوق الآن"),
        "state": MessageLookupByLibrary.simpleMessage("الولاية"),
        "stateIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل المحافظة/الولاية مطلوب"),
        "stateProvince":
        ...
        "storeBanner": MessageLookupByLibrary.simpleMessage("البانر"),
        "storeBrand":
        ...
        "storeListBanner":
            MessageLookupByLibrary.simpleMessage("بانر قائمة المتاجر"),
        "storeLocation": MessageLookupByLibrary.simpleMessage("موقع المتجر"),
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("أدخل العنوان أو المدينة"),
        "storeLogo": MessageLookupByLibrary.simpleMessage("شعار المتجر"),
        "storeMobileBanner":
            MessageLookupByLibrary.simpleMessage("بانر المتجر للهاتف المحمول"),
        "storeSettings": MessageLookupByLibrary.simpleMessage("إعدادات المتجر"),
        "storeSliderBanner":
            MessageLookupByLibrary.simpleMessage("بانر شريط التمرير للمتجر"),
        "storeStaticBanner":
            MessageLookupByLibrary.simpleMessage("بانر ثابت للمتجر"),
        "storeVacation": MessageLookupByLibrary.simpleMessage("إجازة المتجر"),
        "stores": MessageLookupByLibrary.simpleMessage("المتاجر"),
        "street": MessageLookupByLibrary.simpleMessage("الشارع"),
        "street2": MessageLookupByLibrary.simpleMessage("الشارع 2"),
        "streetIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل اسم الشارع مطلوب"),
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "شكراً لطلبك. نعمل بسرعة على معالجته. ترقب رسالة تأكيد بالبريد الإلكتروني قريباً"),
        "submit": MessageLookupByLibrary.simpleMessage("إرسال"),
        "submitYourPost": MessageLookupByLibrary.simpleMessage("أرسل منشورك"),
        ...
        "tapSelectLocation":
            MessageLookupByLibrary.simpleMessage("انقر لاختيار هذا الموقع"),
        "tapTheMicToTalk":
            MessageLookupByLibrary.simpleMessage("انقر على الميكروفون للتحدث"),
        "tax": MessageLookupByLibrary.simpleMessage("ضريبة"),
        "teraWallet": MessageLookupByLibrary.simpleMessage("محفظة تيرا"),
        "terrible": MessageLookupByLibrary.simpleMessage("سيء جداً"),
        "thailand": MessageLookupByLibrary.simpleMessage("التايلاندية"),
        "theFieldIsRequired": m49,
        "thisDateIsNotAvailable":
            MessageLookupByLibrary.simpleMessage("هذا التاريخ غير متاح"),
        "thisFeatureDoesNotSupportTheCurrentLanguage":
            MessageLookupByLibrary.simpleMessage(
                "هذه الميزة لا تدعم اللغة الحالية"),
        "thisIsCustomerRole":
            MessageLookupByLibrary.simpleMessage("هذا دور العميل"),
        "thisIsVendorRole":
            MessageLookupByLibrary.simpleMessage("هذا دور البائع"),
        "thisPlatformNotSupportWebview": MessageLookupByLibrary.simpleMessage(
            "هذا النظام لا يدعم عرض الويب"),
        "thisProductNotSupport":
            MessageLookupByLibrary.simpleMessage("هذا المنتج غير مدعوم"),
        ...
        "titleZToA":
            MessageLookupByLibrary.simpleMessage("العنوان: من الياء إلى الألف"),
        "to": MessageLookupByLibrary.simpleMessage("إلى"),
        "toRate": MessageLookupByLibrary.simpleMessage("للتقييم"),
        "tooManyFailedLogin": MessageLookupByLibrary.simpleMessage(
            "عدد محاولات تسجيل الدخول الفاشلة كثير جداً. الرجاء المحاولة لاحقاً"),
        "topUp": MessageLookupByLibrary.simpleMessage("شحن"),
        "topUpProductNotFound":
            MessageLookupByLibrary.simpleMessage("منتج الشحن غير موجود"),
        "total": MessageLookupByLibrary.simpleMessage("الإجمالي"),
        "totalCartValue":
            MessageLookupByLibrary.simpleMessage("يجب أن لا تقل قيمة الطلب عن"),
        ...
        "transactionFailded":
            MessageLookupByLibrary.simpleMessage("فشلت العملية"),
        "transactionFailed":
            MessageLookupByLibrary.simpleMessage("فشلت العملية"),
        "transactionFee": MessageLookupByLibrary.simpleMessage("رسوم المعاملة"),
        "transactionResult":
            MessageLookupByLibrary.simpleMessage("نتيجة المعاملة"),
        ...
        "transferMoneyTo": m51,
        "transferSuccess": MessageLookupByLibrary.simpleMessage("نجح التحويل"),
        ...
        "uploadProduct": MessageLookupByLibrary.simpleMessage("رفع المنتج"),
        ...
        "useNow": MessageLookupByLibrary.simpleMessage("استخدم الآن"),
        "useThisImage":
            MessageLookupByLibrary.simpleMessage("استخدم هذه الصورة"),
        "userExists": MessageLookupByLibrary.simpleMessage(
            "اسم المستخدم/البريد الإلكتروني غير متاح."),
        "userHasBeenBlocked":
            MessageLookupByLibrary.simpleMessage("تم حظر المستخدم"),
        ...
        "validUntilDate": m53,
        "variable": MessageLookupByLibrary.simpleMessage("متغير"),
        "variation": MessageLookupByLibrary.simpleMessage("تنويع"),
        "vendor": MessageLookupByLibrary.simpleMessage("البائع"),
        "vendorAdmin": MessageLookupByLibrary.simpleMessage("لوحة البائع"),
        ...
        "waitForPost":
            MessageLookupByLibrary.simpleMessage("في انتظار نشر المنتج"),
        ...
        "weFoundBlogs": MessageLookupByLibrary.simpleMessage("وجدنا مدونات"),
        "weFoundProducts": m58,
        "weNeedCameraAccessTo": MessageLookupByLibrary.simpleMessage(
            "نحتاج إلى الوصول إلى الكاميرا للمسح الضوئي لرمز الاستجابة السريعة أو الباركود."),
        "weSentAnOTPTo":
            MessageLookupByLibrary.simpleMessage("تم إرسال رمز التحقق إلى"),
        "weWillSendYouNotification": MessageLookupByLibrary.simpleMessage(
            "سنرسل إليك إشعارات عند توفر اخبار جديدة . يمكنك تغيير هذا الإعداد في أي وقت من الإعدادات."),
        ...
        "withdrawAmount": MessageLookupByLibrary.simpleMessage("مبلغ السحب"),
        "withdrawRequest": MessageLookupByLibrary.simpleMessage("طلب سحب"),
        "withdrawal": MessageLookupByLibrary.simpleMessage("سحب"),
        "womanCollections":
            MessageLookupByLibrary.simpleMessage("مجموعات نسائية"),
        ...
        "youCanOnlyOrderSingleStore": MessageLookupByLibrary.simpleMessage(
            "يمكنك الشراء من متجر واحد فقط في المرة الواحدة."),
        "youCanOnlyPurchase":
            MessageLookupByLibrary.simpleMessage("يمكنك شراء فقط"),
        "youDontHavePermissionToCreatePost":
            MessageLookupByLibrary.simpleMessage(
                "ليس لديك صلاحية لإنشاء منشور"),
        "youHaveAssignedToOrder": m63,
        "youHaveBeenSaveAddressYourLocal":
            MessageLookupByLibrary.simpleMessage("تم حفظ عنوانك في منطقتك"),
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("ليس لديك منشورات"),
        "youHavePoints": m64,
        "youMightAlsoLike":
        ...
        "youNotBeAsked": MessageLookupByLibrary.simpleMessage(
            "لن يتم سؤالك في المرة القادمة بعد الاكتمال"),
        "yourAccountIsUnderReview": MessageLookupByLibrary.simpleMessage(
            "حسابك قيد المراجعة. يرجى الاتصال بالمسؤول إذا كنت بحاجة إلى مساعدة"),
        "yourAddressExistYourLocal":
            MessageLookupByLibrary.simpleMessage("عنوانك موجود في منطقتك"),
        "yourAddressHasBeenSaved":
            MessageLookupByLibrary.simpleMessage("تم حفظ العنوان في جهازك"),
        ...
        "yourOrderIsEmptyMsg": MessageLookupByLibrary.simpleMessage(
            "يبدو أنك لم تضف أي عناصر بعد. ابدأ بالتسوق لملء طلبك"),
        ...
        "zipCodeIsRequired":
            MessageLookupByLibrary.simpleMessage("حقل الرمز البريدي مطلوب")
      };
}
